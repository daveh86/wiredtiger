...
connection_stats = [
    ...
    LogStat('log_release', 'log release calls'),
    LogStat('log_release_lsn',
        'log time spent waiting for write_lsn (msecs)',
        'no_aggregate,no_clear,no_scale'),
    LogStat('log_release_lsn_max',
        'maximum log time spent waiting for write_lsn (msecs)',
        'no_aggregate,no_clear,no_scale'),
    LogStat('log_release_total',
        'log time spent total in write and write_lsn (msecs)',
        'no_aggregate,no_clear,no_scale'),
    LogStat('log_release_total_max',
        'maximum log time spent total in write and write_lsn (msecs)',
        'no_aggregate,no_clear,no_scale'),
    LogStat('log_release_write',
        'log time spent in write (msecs)',
        'no_aggregate,no_clear,no_scale'),
    LogStat('log_release_write_max',
        'maximum log time spent in write (msecs)',
        'no_aggregate,no_clear,no_scale'),
